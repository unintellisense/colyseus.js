...
var Client = (function (_super) {
    ...
    function Client(url, initialRoomStateMap, protocols, options) {
        ...
        _this.initialRoomStateMap = initialRoomStateMap;
        return _this;
    }
    ...
    Client.prototype.join = function (roomName, options) {
        if (!this.rooms[roomName]) {
            this.rooms[roomName] = new Room_1.Room(this, roomName, this.initialRoomStateMap[roomName]);
        }
